...
Download [Steamworks SDK](https://partner.steamgames.com/doc/sdk), unzip it and paste `/sdk` folder in your project's root. Now set an environment variable `STEAM_SDK_LOCATION` pointing to the SDK's folder.
